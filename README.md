The dataset we will be using today has 1142 rows and 9 columns. There are no blank or N/A values, there are however a few ouliers in the time columns. 
...
column that I would be able to aggregate with. I then turned my attention to the date column.
