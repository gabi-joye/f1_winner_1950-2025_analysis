...
has 1142 rows and 9 columns. There are no blank or N/A values, there are however a few outliers in the time columns. While analysing this data we will also need to take into account that race cars have had mechanical advancements that are not noted in this dataset.
